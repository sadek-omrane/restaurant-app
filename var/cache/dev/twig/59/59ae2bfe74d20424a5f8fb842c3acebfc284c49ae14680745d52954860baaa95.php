...
class __TwigTemplate_d02bd79c480c0f9b3cde71feee7505971785b6696351ccea5571478ffec4b5fc extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t<a href=\"{{ path('app_admin_food_crud_show', {'id': food.id}) }}\">show</a>
...
\t\t<a href=\"{{ path('app_admin_food_crud_new') }}\">Create new</a>
\t</div>
{% endblock %}

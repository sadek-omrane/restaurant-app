...
class __TwigTemplate_b3e6d711f337d17c0d4de65353f47e71 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<td>";
            // line 43
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["order"], "total", [], "any", false, false, false, 43), "html", null, true);
            echo "DT</td>
\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t";
            // line 45
...
\t\t\t\t\t\t\t\t";
            // line 55
            if ((twig_get_attribute($this->env, $this->source, $context["order"], "isDelivred", [], "any", false, false, false, 55) == false)) {
                // line 56
...
\t\t\t\t\t\t\t\t\t";
                // line 58
                if ((twig_get_attribute($this->env, $this->source, $context["order"], "isPayed", [], "any", false, false, false, 58) == false)) {
                    // line 59
                    echo "\t\t\t\t\t\t\t\t\t\t<a class=\"btn btn-primary\" href=\"";
...
", "order/index.html.twig", "/home/sadek/projects/symfony-restaurants/templates/order/index.html.twig");
    }
}

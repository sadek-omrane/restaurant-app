...
/* base.html.twig */
class __TwigTemplate_fa59db3e379b13de4ca8dcd08f6c7fd8 extends Template
{
    private $source;
    private $macros = [];
...
\t<body ";
        // line 45
        if (((isset($context["route_name"]) || array_key_exists("route_name", $context) ? $context["route_name"] : (function () { throw new RuntimeError('Variable "route_name" does not exist.', 45, $this->source); })()) != "home")) {
            echo " class=\"sub_page\" ";
        }
        echo ">
\t\t";
...
", "base.html.twig", "/home/sadek/projects/symfony-restaurants/templates/base.html.twig");
    }
}

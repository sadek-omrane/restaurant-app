...
/* food/food.html.twig */
class __TwigTemplate_7a699dafa0f1616762c01f07077da532a00abdd09f008bd9789cfbab2f3246f0 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "food/food.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "food/food.html.twig", 1);
...
\t\t\t\t\t\t\t<a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_order_new", ["id" => twig_get_attribute($this->env, $this->source, $context["food"], "id", [], "any", false, false, false, 29)]), "html", null, true);
...
\t\t\t\t\t\t\t<h6 class=\"card-subtitle mb-2 text-muted\">Price:
\t\t\t\t\t\t\t\t{{food.price}}DT</h6>
\t\t\t\t\t\t\t<a href=\"{{ path('app_order_new', {id: food.id}) }}\" class=\"btn btn-primary\">Order</a>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t{% endfor %}
\t\t\t</div>
...
\t</div>
{% endblock %}
", "food/food.html.twig", "/home/sadek/projects/Restaurant/templates/food/food.html.twig");
    }
}

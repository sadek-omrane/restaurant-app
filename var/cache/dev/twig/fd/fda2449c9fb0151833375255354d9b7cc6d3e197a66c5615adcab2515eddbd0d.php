...
class __TwigTemplate_164e51c2e79bde456d037ea7f95eab0ca47ee1a4b78ae79bb5656c66d3743efe extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<button type=\"submit\" style=\"width: 110px\" class=\"btn btn btn-lg btn-primary\">Sign Up</button>
\t\t\t";
        // line 58
...
";
    ...
    {
        return array (  196 => 58,  189 => 54,  185 => 53,  179 => 50,  175 => 49,  170 => 47,  165 => 45,  159 => 42,  155 => 41,  150 => 39,  145 => 37,  139 => 34,  135 => 33,  130 => 31,  125 => 29,  119 => 26,  115 => 25,  110 => 23,  105 => 21,  99 => 18,  95 => 17,  90 => 15,  85 => 13,  78 => 9,  74 => 7,  67 => 6,  53 => 3,  36 => 1,);
    }
...
\t\t\t\t</div>
\t\t\t\t{{ form_widget(registrationForm.email, {'attr': {'class': 'form-control frm-input'}}) }}
...
\t\t\t\t</div>
\t\t\t\t{{ form_widget(registrationForm.plainPassword, {'attr': {'class': 'form-control frm-input'}}) }}
...
\t\t\t\t</div>
\t\t\t\t{{ form_widget(registrationForm.name, {'attr': {'class': 'form-control frm-input'}}) }}
...
\t\t\t\t</div>
\t\t\t\t{{ form_widget(registrationForm.cin, {'attr': {'class': 'form-control frm-input'}}) }}
...
\t\t\t\t</div>
\t\t\t\t{{ form_widget(registrationForm.phone, {'attr': {'class': 'form-control frm-input'}}) }}
\t\t\t\t<small>{{ form_help(registrationForm.phone) }}</small>
\t\t\t</div>
\t\t\t<div>
\t\t\t\t{{ form_widget(registrationForm.agreeTerms, {'attr': {'class': 'frm-input'}}) }}
...
{% endblock %}
", "registration/register.html.twig", "/home/sadek/projects/project1/templates/registration/register.html.twig");
    }
}

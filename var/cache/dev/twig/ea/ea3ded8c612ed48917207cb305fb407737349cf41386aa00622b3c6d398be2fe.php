...
class __TwigTemplate_efb1947ae844c93f0c6ffd0c9d03aebecdaa1f457b247253dde89fab40a2227a extends Template
{
    private $source;
    private $macros = [];
...
\t\t<button style=\"width: 80px; margin: 16px 0 0 10px;\" class=\"btn btn-primary\">";
        // line 15
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 15, $this->source); })()), "Order")) : ("Order")), "html", null, true);
        echo "</button>
...
";
    ...
    {
        return array (  79 => 17,  74 => 15,  69 => 13,  63 => 10,  59 => 9,  54 => 7,  49 => 5,  44 => 3,  40 => 1,);
    }

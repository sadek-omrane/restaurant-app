...
class __TwigTemplate_88af29dbda240212990b902641e40307fcc20f379088f49e0bd53a0e9ec4e6c6 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<a href=\"";
            ...
            echo "\" ";
            if (twig_in_filter((isset($context["route_name"]) || array_key_exists("route_name", $context) ? $context["route_name"] : (function () { throw new RuntimeError('Variable "route_name" does not exist.', 42, $this->source); })()), [0 => "app_admin_food_crud_index", 1 => "app_admin_food_crud_new", 2 => "app_admin_food_crud_show", 3 => "app_admin_food_crud_edit", 4 => "app_admin_food_crud_delete"])) {
                echo " class=\"nav-link link-dark active\" style=\"background-color: #ffbe33;\" ";
            } else {
                echo " class=\"nav-link link-dark\" style=\"background-color: transparent;\" ";
            }
...
\t\t\t\t\t\t\t<a href=\"";
            ...
            echo "\" ";
            if (twig_in_filter((isset($context["route_name"]) || array_key_exists("route_name", $context) ? $context["route_name"] : (function () { throw new RuntimeError('Variable "route_name" does not exist.', 48, $this->source); })()), [0 => "app_admin_category_crud_index", 1 => "app_admin_category_crud_new", 2 => "app_admin_category_crud_show", 3 => "app_admin_category_crud_edit", 4 => "app_admin_category_crud_delete"])) {
                echo " class=\"nav-link link-dark active\" style=\"background-color: #ffbe33;\" ";
            } else {
                echo " class=\"nav-link link-dark\" style=\"background-color: transparent;\" ";
            }
...
\t\t\t\t";
    ...
    {
        return array (  237 => 62,  230 => 61,  218 => 54,  203 => 48,  188 => 42,  185 => 41,  170 => 35,  167 => 34,  165 => 33,  151 => 28,  147 => 26,  132 => 20,  129 => 19,  127 => 18,  113 => 13,  110 => 12,  108 => 11,  103 => 8,  96 => 7,  86 => 64,  84 => 61,  81 => 60,  79 => 7,  76 => 6,  69 => 5,  55 => 3,  38 => 1,);
    }

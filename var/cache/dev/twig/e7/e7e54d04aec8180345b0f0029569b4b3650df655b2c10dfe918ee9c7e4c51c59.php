...
class __TwigTemplate_52fef30a2bf5fb244d5b7887d1da172d5baa7292daea457057c39bbdc0b46291 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<button>";
        // line 30
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 30, $this->source); })()), "Book Now")) : ("Book Now")), "html", null, true);
        echo "</button>
\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  107 => 33,  101 => 30,  94 => 26,  90 => 25,  85 => 23,  80 => 21,  74 => 18,  70 => 17,  65 => 15,  60 => 13,  53 => 9,  47 => 6,  40 => 1,);
    }

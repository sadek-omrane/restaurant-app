...
class __TwigTemplate_d85ab83e03f5a668954ce84c368a2c6b9aa9059ae4f0545661ec9ea53a979343 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        // line 50
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 50, $this->source); })()), "isDelivred", [], "any", false, false, false, 50), false))) {
            // line 51

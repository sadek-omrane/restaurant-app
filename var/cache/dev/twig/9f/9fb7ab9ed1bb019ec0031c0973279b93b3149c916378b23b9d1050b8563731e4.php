...
class __TwigTemplate_d9b381ee00d22e00de87a648b9163db0c48847da62c9b52bb481b7252c332b7c extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        // line 75
        if ((0 === twig_compare((isset($context["route_name"]) || array_key_exists("route_name", $context) ? $context["route_name"] : (function () { throw new RuntimeError('Variable "route_name" does not exist.', 75, $this->source); })()), "home"))) {
            // line 76
...
";
    ...
    {
        return array (  246 => 154,  166 => 76,  164 => 75,  155 => 68,  147 => 64,  140 => 60,  133 => 56,  122 => 48,  115 => 43,  113 => 42,  106 => 38,  100 => 35,  91 => 29,  88 => 28,  85 => 27,  79 => 24,  70 => 23,  67 => 22,  65 => 21,  44 => 3,  40 => 1,);
    }
...
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"{{path('booking')}}\">Book Table</a>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t<div class=\"user_option\">
\t\t\t\t\t\t\t\t{% if app.user %}
...
\t\t\t\t<!-- end slider section -->
\t\t\t</div>
", "base/header.html.twig", "/home/sadek/projects/Restaurant/templates/base/header.html.twig");
    }
}

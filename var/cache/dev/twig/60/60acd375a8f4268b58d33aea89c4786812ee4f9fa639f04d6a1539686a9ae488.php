...
class __TwigTemplate_69be8fef8edfe77583939754a24334efd06e3ad5e2ce5fbee2233e29dd6b25bd extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t<a href=\"{{ path('app_admin_restaurant_crud_show', {'id': restaurant.id}) }}\">show</a>
...
\t\t<a href=\"{{ path('app_admin_restaurant_crud_new') }}\">Create new</a>
\t</div>
{% endblock %}

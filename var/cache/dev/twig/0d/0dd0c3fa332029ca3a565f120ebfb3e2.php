...
class __TwigTemplate_87e51d604213cf72eae711a22977e8ee extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        // line 52
        if ((twig_length_filter($this->env, (isset($context["restaurants"]) || array_key_exists("restaurants", $context) ? $context["restaurants"] : (function () { throw new RuntimeError('Variable "restaurants" does not exist.', 52, $this->source); })())) > 1)) {
            // line 53
            echo "\t\t\t\t\t";
            if (((twig_length_filter($this->env, (isset($context["restaurants"]) || array_key_exists("restaurants", $context) ? $context["restaurants"] : (function () { throw new RuntimeError('Variable "restaurants" does not exist.', 53, $this->source); })())) % 2) == 0)) {
                // line 54
                echo "\t\t\t\t\t\t";
                $context['_parent'] = $context;
...
\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
            // line 268
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_order_new", ["Fid" => twig_get_attribute($this->env, $this->source, $context["food"], "id", [], "any", false, false, false, 268), "Rid" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["food"], "restaurant", [], "any", false, false, false, 268), "id", [], "any", false, false, false, 268), "Uid" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 268, $this->source); })()), "user", [], "any", false, false, false, 268), "id", [], "any", false, false, false, 268)]), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t\t\t\t\t\t<span style=\"color: white; font-size: 18px\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa-solid fa-cart-shopping\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t</span>
...
\t";
        // line 320
        echo twig_include($this->env, $context, "home/booking/_form.html.twig");
        echo "
...
\t\t</div>
\t</section>
\t{{ include('home/booking/_form.html.twig')}}
\t<section class=\"client_section layout_padding-bottom\">
\t\t<div class=\"container\">
\t\t\t<div class=\"heading_container heading_center psudo_white_primary mb_45\">
\t\t\t\t<h2>
...
\t</section>
{% endblock %}
", "home/index.html.twig", "/home/sadek/projects/symfony-restaurants/templates/home/index.html.twig");
    }
}

...
class __TwigTemplate_2dc1d06ff23b5516be8bfe5712babced13598cf22fc9d7f383de1f09b3f046a8 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t</div>
\t\t\t{{ form_widget(form.roles, {'attr': {'class': 'form-control frm-input'}}) }}
...
\t\t</div>
\t\t<button style=\"width: 80px; margin: 16px 0 0 10px;\" class=\"btn btn-primary\">{{ button_label|default('Save') }}</button>

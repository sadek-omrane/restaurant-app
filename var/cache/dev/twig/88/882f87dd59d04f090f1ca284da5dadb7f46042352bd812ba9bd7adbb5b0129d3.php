...
class __TwigTemplate_0a06cfabb5deef6405ea27e295cfe99abfe5615f475e4406294ec11f638c15ad extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<td>{{ user.phone }}</td>
\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t<a href=\"{{ path('app_admin_user_crud_show', {'id': user.id}) }}\">show</a>
...
\t\t<a href=\"{{ path('app_admin_user_crud_new') }}\">Create new</a>
\t</div>
{% endblock %}

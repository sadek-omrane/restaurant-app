...
class BookingController extends AbstractController
{
    ...
    public function index(BookingRepository $bookingRepository): Response
    {
        return $this->render('home/booking/index.html.twig', [
            'bookings' => $bookingRepository->findBy(['owner' => $this->getUser()]),
        ]);
    }
    ...
    public function new(Request $request, BookingRepository $bookingRepository): Response
    {
        ...
        return $this->renderForm('home/booking/new.html.twig', [
            'booking' => $booking,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('home/booking/show.html.twig', [
            'booking' => $booking,
        ]);
    }
    ...
    public function edit(Request $request, Booking $booking, BookingRepository $bookingRepository): Response
    {
        ...
        return $this->renderForm('home/booking/edit.html.twig', [
            'booking' => $booking,
            'form' => $form,
        ]);
    }
